...
namespace objl
{
    ...
    namespace algorithm
    {
        ...
        inline bool SameSidePoop(Vector3 p1, Vector3 p2, Vector3 a, Vector3 b)
        {
        ...
        inline bool inTriangle(Vector3 point, Vector3 tri1, Vector3 tri2, Vector3 tri3)
        {
            ...
            bool within_tri_prisim = SameSidePoop(point, tri1, tri2, tri3) && SameSidePoop(point, tri2, tri1, tri3)
                                     && SameSidePoop(point, tri3, tri1, tri2);
